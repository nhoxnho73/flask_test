# abort return status code, flash return message
...
def add_department():
    """
    add a the department to the database
    """
    check_admin()
...
def edit_department(id):
    ...
    return render_template('admin/departments/department.html', action="Edit", add_department=add_department,
